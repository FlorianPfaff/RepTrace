...
class SubjectStageResult:
    """Paths and counts produced by staging one THINGS-EEG2 subject."""
...
def find_preprocessed_file(things_root: Path, subject: str, partition: str) -> Path:
    """Find one subject/partition array in common THINGS-EEG2 layouts."""
...
def load_label_map(
    ...
    *,
    ...
    """Load condition-to-label metadata used to form benchmark classes."""
...
def stage_subject(
    *,
    ...
    """Convert one THINGS-EEG2 preprocessed subject array into MNE Epochs plus metadata."""
...
def write_manifest(
    ...
    *,
    ...
    """Write a RepTrace benchmark manifest for staged THINGS-EEG2 subjects."""
